...
def parse_args():
    parser = argparse.ArgumentParser(description="Compute CLIP baseline quality score.")
    # data
    ...
    parser.add_argument("--save_filename", type=str, default="data_info_clip.json")
    parser.add_argument("--save_key", type=str, default="clip_similarity",
...
def main():
    ...
    # --- load CLIP model ---
    print("\nLoading CLIP model: {}".format(args.clip_model_name))
    ...
    for batch in tqdm(build_batches(dataset, args.batchsize)):
        ...
        for data in batch:
            ...
            texts.append(clip.tokenize(data["caption"], context_length=77, truncate=True))
        ...
        # cosine similarity per pair = diagonal of the [bs, bs] similarity matrix
